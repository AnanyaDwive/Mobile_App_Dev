...
class Restaurant extends ChangeNotifier {
 ...
 final List<Food> _menu = [
   ...
   Food(
     ...
     imagePath: "lib/images/sides/mac_and_cheese.jpg",
     price: 150,
     category: FoodCategory.sides,
     availableAddons: [
       Addon(name: "Panner bits", price: 40),
   ...
   Food(
     ...
     imagePath: "lib/images/sides/sweet_potato_sand.jpg",
     price: 220,
     category: FoodCategory.sides,
     availableAddons: [
       Addon(name: "Grilled Panner", price: 70),
   ...
   Food(
     ...
     imagePath:
         "lib/images/drinks/lemon-drop-martini-cocktail-isolated-white-background_123827-24018.jpeg",
     price: 220,
     category: FoodCategory.drinks,
     availableAddons: [
       Addon(name: "Extra vodka", price: 50),
   ...
   Food(
     ...
     imagePath: "lib/images/drinks/kombucha-drink-isolated_23-2151264043.jpeg",
     price: 180,
     category: FoodCategory.drinks,
     availableAddons: [
   ...
   Food(
     ...
     imagePath:
         "lib/images/drinks/long-island-ice-tea-cocktail-realistic_1284-3888.jpeg",
     price: 300,
     category: FoodCategory.drinks,
     availableAddons: [
       Addon(name: "Extra vodka", price: 50),
   ...
   Food(
     ...
     imagePath: "lib/images/desserts/chocolate-ice-cream-cake_1339-1731.jpg",
     price: 250,
     category: FoodCategory.desserts,
     availableAddons: [
       Addon(name: "Whipped cream", price: 20),
   ...
   Food(
     ...
     imagePath: "lib/images/desserts/cupcakes_1203-6827.jpeg",
     price: 120,
     category: FoodCategory.desserts,
     availableAddons: [
   ...
   Food(
     ...
     imagePath:
         "lib/images/desserts/macaroon-isolated-transparent-background_191095-39828.jpeg",
     price: 150,
     category: FoodCategory.desserts,
     availableAddons: [
   ...
   Food(
     ...
     imagePath:
         "lib/images/desserts/spaghettieis-ice-cream-isolated-transparent-background_191095-34599.jpeg",
     price: 220,
     category: FoodCategory.desserts,
     availableAddons: [
